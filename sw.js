  ...
  e.respondWith(
    caches.match(e.request).then(hit => {
      ...
      return fetch(e.request).then(res => {
        ...
        if (res.ok && (e.request.url.startsWith(self.location.origin) || /fonts\.gstatic|jsdelivr|upload\.wikimedia\.org|en\.wikipedia\.org\/api|commons\.wikimedia\.org/.test(e.request.url))) {
